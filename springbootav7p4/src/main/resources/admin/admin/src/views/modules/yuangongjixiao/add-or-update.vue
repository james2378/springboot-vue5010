	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="员工考勤" prop="yuangongkaoqin">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="员工考勤" prop="yuangongkaoqin">
					<el-input v-model="ruleForm.yuangongkaoqin"
						placeholder="员工考勤" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="工作态度" prop="gongzuotaidu">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="工作态度" prop="gongzuotaidu">
					<el-input v-model="ruleForm.gongzuotaidu"
						placeholder="工作态度" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="业务技能" prop="yewujineng">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="业务技能" prop="yewujineng">
					<el-input v-model="ruleForm.yewujineng"
						placeholder="业务技能" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="工作成绩" prop="gongzuochengji">
					<el-select :disabled="ro.gongzuochengji" v-model="ruleForm.gongzuochengji" placeholder="请选择工作成绩" >
						<el-option
							v-for="(item,index) in gongzuochengjiOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="工作成绩" prop="gongzuochengji">
					<el-input v-model="ruleForm.gongzuochengji"
						placeholder="工作成绩" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="总得分" prop="zongdefen">
					<el-input v-model="zongdefen" placeholder="总得分" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.zongdefen" label="总得分" prop="zongdefen">
					<el-input v-model="ruleForm.zongdefen" placeholder="总得分" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="评价等级" prop="pingjiadengji">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="评价等级" prop="pingjiadengji">
					<el-input v-model="ruleForm.pingjiadengji"
						placeholder="评价等级" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="绩效月份" prop="jixiaoyuefen">
					<el-input v-model="ruleForm.jixiaoyuefen" placeholder="绩效月份" clearable  :readonly="ro.jixiaoyuefen"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="绩效月份" prop="jixiaoyuefen">
					<el-input v-model="ruleForm.jixiaoyuefen" placeholder="绩效月份" readonly></el-input>
				</el-form-item>
			</template>
...
export default {
	...
	computed: {
		zongdefen: {
			get: function () {
				return 0+parseFloat(this.ruleForm.yuangongkaoqin==""?0:this.ruleForm.yuangongkaoqin)+parseFloat(this.ruleForm.gongzuotaidu==""?0:this.ruleForm.gongzuotaidu)+parseFloat(this.ruleForm.yewujineng==""?0:this.ruleForm.yewujineng)+parseFloat(this.ruleForm.gongzuochengji==""?0:this.ruleForm.gongzuochengji) || 0
			}
		},
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='gongzuochengji'){
							this.ruleForm.gongzuochengji = obj[o];
							this.ro.gongzuochengji = true;
							continue;
						}
						if(o=='zongdefen'){
            ...
            this.yuangongkaoqinOptions = "5,10,15,20,25".split(',')
            this.gongzuotaiduOptions = "5,10,15,20,25".split(',')
            this.yewujinengOptions = "5,10,15,20,25".split(',')
            this.gongzuochengjiOptions = "5,10,15,20,25".split(',')
