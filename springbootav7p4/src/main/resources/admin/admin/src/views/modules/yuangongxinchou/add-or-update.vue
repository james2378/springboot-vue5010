	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="工资月份" prop="gongziyuefen">
					<el-input v-model="ruleForm.gongziyuefen" placeholder="工资月份" clearable  :readonly="ro.gongziyuefen"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="工资月份" prop="gongziyuefen">
					<el-input v-model="ruleForm.gongziyuefen" placeholder="工资月份" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="绩效奖励" prop="jixiaojiangli">
					<el-input v-model="ruleForm.jixiaojiangli" placeholder="绩效奖励" clearable  :readonly="ro.jixiaojiangli"></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="加班补助" prop="jiabanbuzhu">
					<el-input v-model="ruleForm.jiabanbuzhu" placeholder="加班补助" clearable  :readonly="ro.jiabanbuzhu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="加班补助" prop="jiabanbuzhu">
					<el-input v-model="ruleForm.jiabanbuzhu" placeholder="加班补助" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="五险一金" prop="wuxianyijin">
					<el-input v-model="ruleForm.wuxianyijin" placeholder="五险一金" clearable  :readonly="ro.wuxianyijin"></el-input>
				</el-form-item>
...
export default {
	...
	computed: {
		shifagongzi: {
			get: function () {
				return 0+parseFloat(this.ruleForm.jibengongzi==""?0:this.ruleForm.jibengongzi)+parseFloat(this.ruleForm.jixiaojiangli==""?0:this.ruleForm.jixiaojiangli)+parseFloat(this.ruleForm.jiabanbuzhu==""?0:this.ruleForm.jiabanbuzhu)-parseFloat(this.ruleForm.wuxianyijin==""?0:this.ruleForm.wuxianyijin)-parseFloat(this.ruleForm.koukuanjine==""?0:this.ruleForm.koukuanjine) || 0
			}
		},
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='jiabanbuzhu'){
							this.ruleForm.jiabanbuzhu = obj[o];
							this.ro.jiabanbuzhu = true;
							continue;
						}
						if(o=='wuxianyijin'){
