	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="部门" prop="bumen">
					<el-input v-model="ruleForm.bumen" placeholder="部门" clearable  :readonly="ro.bumen"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="部门" prop="bumen">
					<el-input v-model="ruleForm.bumen" placeholder="部门" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="职位" prop="zhiwei">
					<el-input v-model="ruleForm.zhiwei" placeholder="职位" clearable  :readonly="ro.zhiwei"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="职位" prop="zhiwei">
					<el-input v-model="ruleForm.zhiwei" placeholder="职位" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="晋升职位" prop="jinshengzhiwei">
					<el-input v-model="ruleForm.jinshengzhiwei" placeholder="晋升职位" clearable  :readonly="ro.jinshengzhiwei"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="晋升职位" prop="jinshengzhiwei">
					<el-input v-model="ruleForm.jinshengzhiwei" placeholder="晋升职位" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="晋升时间" prop="jinshengshijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.jinshengshijian" 
						type="datetime"
						:readonly="ro.jinshengshijian"
						placeholder="晋升时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.jinshengshijian" label="晋升时间" prop="jinshengshijian">
					<el-input v-model="ruleForm.jinshengshijian" placeholder="晋升时间" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="晋升原因" prop="jinshengyuanyin">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="晋升原因"
					  v-model="ruleForm.jinshengyuanyin" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else-if="ruleForm.jinshengyuanyin" label="晋升原因" prop="jinshengyuanyin">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}'>{{ruleForm.jinshengyuanyin}}</span>
				</el-form-item>
	...
	data() {
		...
		return {
			...
			ro:{
				...
				bumen : false,
				zhiwei : false,
				jinshengzhiwei : false,
				jinshengshijian : false,
				jinshengyuanyin : false,
			},
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='jinshengzhiwei'){
							this.ruleForm.jinshengzhiwei = obj[o];
							this.ro.jinshengzhiwei = true;
							continue;
						}
						if(o=='jinshengshijian'){
							this.ruleForm.jinshengshijian = obj[o];
							this.ro.jinshengshijian = true;
							continue;
						}
						if(o=='jinshengyuanyin'){
							this.ruleForm.jinshengyuanyin = obj[o];
							this.ro.jinshengyuanyin = true;
							continue;
						}
				}
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jinshengxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jinshengxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
